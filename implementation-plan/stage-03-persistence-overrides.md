...
| --- | --- | --- | --- | --- |
| S3-T1 | Design DB schema per Spec §20 | Backend Architect | Stage 2 DB tooling | ⏳ (override/review tables defined; classifications/audit pending) |
| S3-T2 | Implement migrations + tooling | Backend Eng | S3-T1 | ⏳ (sqlx migrations + env wiring merged) |
| S3-T3 | Build override API/service + caching hooks | Backend Eng | S3-T2 | ⏳ (list/create/delete endpoints live; caching hooks TBD) |
