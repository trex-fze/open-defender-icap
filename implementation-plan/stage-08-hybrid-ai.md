...
| S8-T7 | Security/perf validation (prompt injection, fallback load) | Security/Perf Eng | S8-T2–T4 | 🔄 | `tests/security/llm-prompt-smoke.sh` added; fallback perf + k6 scenario pending |
