...
| S5-T6 | UI/CLI e2e + accessibility tests | QA | S5-T3/T4 | 🔄 | Vitest coverage for Auth + hooks + guards added; odctl integration tests cover policy/override + device flow. Accessibility + Cypress flows still outstanding |
