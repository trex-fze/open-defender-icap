...
| S2-T5 | Implement policy CRUD + simulation APIs with auth | Backend Eng | S2-T4 | 🟡 | File/DB create + simulate endpoints with token guard; remaining work: full RBAC/trace UI + audit. |
