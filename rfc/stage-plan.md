...
| 24. Reliability and Operability Hardening | Config contract fail-fast validation, queue replay/idempotency hardening, unified diagnostics, auth/session lifecycle hardening, golden deployment profile | Spec §§8, 10, 24-31, 33-35 | 🟡 Proposed | RFC: `rfc/stage-24-reliability-operability-hardening.md`; implementation tracked in `implementation-plan/stage-24-reliability-operability-hardening.md`. |
