...
Run ID: 20260327-161146

Target: www.facebook.com
Proxy: http://localhost:3128
Artifacts: tests/artifacts/facebook-e2e/20260327-161146

| Stage | Label | Status | Description |
| --- | --- | --- | --- |
| S00 | Preflight | PASS | Services healthy; category disabled; LLM ready via local |
| S01 | Client Initial Request | PASS | Initial request blocked with HTTP 000 (curl exit 7) |
| S02 | Squid Logs | FAIL | CONNECT www.facebook.com missing in squid logs and ICAP fallback |
...
| S10 | Client Follow-up Request | PASS | Follow-up request blocked with HTTP 000 (curl exit 7) |
| S11 | ICAP Final Decision | FAIL | No ICAP final decision log found for follow-up |
